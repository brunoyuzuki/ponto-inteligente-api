...
public class FuncionarioController {
	...
	public ResponseEntity<Response<FuncionarioDto>> atualizar(@PathVariable("id") Long id,
		...
		/**
		 * Atualiza od dados do funcionário com base nos dados encontrados no DTO.
		 * 
		 * @param funcionario
		 * @param funcionarioDto
		 * @param result
		...
		private void atualizarDadosFuncionario (Funcionario funcionario, FuncionarioDto funcionarioDto, BindingResult result)
			...
			funcionarioDto.getQtdHorasTrabalhoDia()
					.ifPresent(qtdQtdHorasTrabalhoDia -> funcionario.setQtdHorasTrabalhoDia(Float.valueOf(qtdQtdHorasTrabalhoDia)));
